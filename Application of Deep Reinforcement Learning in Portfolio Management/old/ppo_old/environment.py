...
class TradingEnv:
    ...
    def save(self, name="ppo"):
        ...
        self.actor.actor.save_weights(f"./ppo_old/{name}_Actor.h5")
        self.critic.critic.save_weights(f"./ppo_old/{name}_Critic.h5")

    def load(self, name="ppo"):
        # load keras model weights
        self.actor.actor.load_weights(f"./ppo_old/{name}_Actor.h5")
        self.critic.critic.load_weights(f"./ppo_old/{name}_Critic.h5")
